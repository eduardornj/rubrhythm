        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-slate-800/50 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-6 mb-6">
              ...
              {listing.isMock ? (
                <div className="flex items-center gap-3 py-3 px-4 bg-white/5 rounded-xl border border-white/10">
                  ...
                  <p className="text-gray-400 text-sm">Contact available after registration</p>
                </div>
              ) : (
                <>
              ...
              {!listing.isMock && listing.whatsapp && (
                <div className="mb-4">
                  <a
              ...
              {!listing.isMock && listing.telegram && (
                <div className="mb-4">
                  <a
              ...
              {!listing.isMock && listing.websiteUrl && (
                <div className="mb-4">
                  <a
