  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="glass-card p-6 bg-gradient-to-r from-accent/10 via-background to-primary/10 border-accent/20">
        <h1 className="text-xl font-black text-white mb-1">Referral Program</h1>
        <p className="text-text-muted text-sm">
          Invite friends and earn credits for every sign-up.
        </p>
      </div>
      ...
      <div className="glass-card p-5">
        ...
        <div className="grid grid-cols-3 gap-4">
          {[
            ...
            { step: "2", title: "They Sign Up", desc: "They get +5 bonus credits" },
            { step: "3", title: "You Earn", desc: "+10 credits per referral" },
          ].map(item => (
      ...
      <div className="glass-card p-5 space-y-4">
        <h2 className="text-white font-semibold">Your Referral Code</h2>
        {!data ? (
          ...
          <>
            ...
            <div className="flex items-center gap-2">
              <p className="text-white/30 text-xs mr-1">Share via:</p>
              <button
            ...
            <div className="flex items-center gap-4 pt-2">
              ...
              <div className="glass-card p-4 flex-1 text-center bg-primary/5 border-primary/20">
                ...
                <p className="text-xs text-text-muted mt-1">Credits Earned</p>
              </div>
            </div>
          </>
        )}
